...
const TR: Record<string, string> = {
  ...
  Badge: 'Rozet',
  Free: 'Serbest',
  'Fill image': 'Dolgu görseli',
  'Click an image again to remove it.': 'Kaldırmak için görsele tekrar tıkla.',
  'Remove fill image': 'Dolgu görselini kaldır',
  'Pin image': 'Pin görseli',
  'Fill opacity': 'İç opaklık',
  'Outline thickness': 'Dış hat kalınlığı',
